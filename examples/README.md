...
If you used the playbook and shipped something, open a PR to add it here.

| # | Archetype | Example | Status |
|---|-----------|---------|--------|
...
| 3 | Policy memo / staff bill analysis | None public — memos are usually private through active negotiation | n/a by design |
